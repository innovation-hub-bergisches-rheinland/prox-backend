...
class ApplyCommitmentHandlerTest {
  ...
  ApplyCommitmentHandler applyCommitmentHandler = new ApplyCommitmentHandler(projectRepository);
  ...
  void shouldApplyCommitment() {
    ...
    var response = applyCommitmentHandler.handle(project.getId(), userId);
