package de.innovationhub.prox.modules.user.application.web;

import de.innovationhub.prox.modules.user.application.usecase.commands.StarProjectHandler;
import de.innovationhub.prox.modules.user.application.usecase.commands.UnstarProjectHandler;
