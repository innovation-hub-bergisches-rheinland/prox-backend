...
import de.innovationhub.prox.modules.user.application.lecturer.web.dto.CreateLecturerRequestDto.CreateLecturerProfileDto;
...
class LecturerProfileControllerIntegrationTest extends AbstractIntegrationTest {
  ...
  private LecturerProfile createDummyLecturer() {
    var lecturer = LecturerProfile.create(UUID.fromString(USER_ID), "Max Mustermann");
